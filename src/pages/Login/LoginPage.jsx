...
const LoginPage = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://wiciki-media-backend-ahiu.onrender.com/auth-user/login",
        {
          email: loginEmail,
  ...
  const checkEmail = async (email) => {
    ...
    try {
      const res = await axios.post(
        `https://wiciki-media-backend-ahiu.onrender.com/verify/check-email`, {
        email
      }
      );
  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(
        "https://wiciki-media-backend-ahiu.onrender.com/auth-user/register",
        {
          name: signupName,
          email: signupEmail,
  ...
  const GoogleLogin = () => {
    ...
    window.location.href = "https://wiciki-media-backend-ahiu.onrender.com/auth/google";
  };
